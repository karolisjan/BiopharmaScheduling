...
cdef extern from "models.h" namespace "deterministic":
...
cdef extern from "models.h" namespace "deterministic" nogil:
    cdef cppclass SingleSiteModel:
        SingleSiteModel()
        SingleSiteModel(InputData input_data)
        void CreateSchedule[Individual](Individual &individual, Schedule &schedule)
